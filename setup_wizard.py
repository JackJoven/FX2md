...
DEFAULT_MD_PATH = os.path.join(HOME, "Desktop", "FX2md", "MD")
DEFAULT_VIDEO_PATH = os.path.join(HOME, "Desktop", "FX2md", "Videos")
...
class SetupWizard:
    ...
    def _step_welcome(self):
        ...
        tk.Label(self.content_frame, text="欢迎使用 FX2md",
    ...
    def _step_extension(self):
        ...
        tk.Label(self.content_frame,
                 text="FX2md 需要安装配套的 Chrome 扩展才能在推特页面上抓取内容",
                 font=FONT(12), fg=C["muted"], bg=C["bg"]).pack(
            anchor="w", pady=(0, 14))
    ...
    def _step_finish(self):
        ...
        tk.Label(self.content_frame,
                 text="点击「启动服务」后，FX2md 将在系统托盘后台运行\n在 Chrome 中使用扩展即可开始保存推文",
